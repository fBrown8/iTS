...
<head>
    ...
    <link rel="stylesheet" href="../css/superadmin-addNewFAQs.css">
    <!--Font Awesome-->
    ...
    <title>Super Admin - Add New Service | I-SCoTS</title>
</head>
<body>
...
<div class="edit-container">
    <br>
    <h2>Add New Frequently Asked Questions</h2>
    <h3>Question:</h3>

    <div class="input-box">
        <input type="text" name="questions" id="service-new">
    </div>
    ...
    <h3>Description:</h3>
      ...
      <div class="input-box">
          <textarea id="description" name="answers" rows="5" cols="108"></textarea>
    </div>
  
      <div class="save-btn" style="text-align: center;">
          <button type="submit" name="adminfaqs_btn" id="saveChanges-btn">Add</button>
