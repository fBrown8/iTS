...
<head>
    ...
    <link rel="stylesheet" href="../css/superadmin-manageFAQs.css">
    ...
    <title>Super Admin - Manage Frequently Asked Questions | I-SCoTS</title>
</head>
<body>
...
<div class="header">
    ...
    <div class="button">
        <button id="new" onclick="window.location.href = 'superadmin-addNewFAQs.php';">+ ADD NEW</button>
    </div>
</div>
...
<div class="faqs-table">
    ...
    <table class="faq-list" id = "table">
        <thead>
          <tr>
            <th id="question">QUESTION</th>
            <th id="answers">ANSWERS</th>
            <th id="action-btns">ACTIONS</th>
          </tr>
        </thead>
        <tbody>
        ...
        <?php
          ...
          <tr id="service-type">
            <td id="faq"><p><?php echo $row ['questions']; ?></p></td>
            <td id="answer"><p><?php echo $row ['answers']; ?></p></td>
            <td valign="bottom" align="center">

                <form action = "superadmin-editFAQs.php" method = "POST">
