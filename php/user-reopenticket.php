      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link text-white" href="user-faqspage.html">FAQs</a>
            </li>
...
<div class="service-request-form">
  <div class="header">
    ...
    <div class="form-content">
      <p class = "requiredfield"><span style="color: red;">*</span> indicates required fields</p>
      ...
      <form action="#">
        ...
        <section>
          ...
          <div class="form-group">
            <label for="Category" style="margin-left: 5px;">Category<span style="color: red;">*</span></label>
        ...
        <section>
          <div class="input-block description">
            <label for="concern">Description of Concern<span style="color: red;">*</span></label>
        ...
        <section>
            <div class="input-block description">
              <label for="concern">Reason for reopening the ticket<span style="color: red;">*</span></label>
              <textarea name="concern" id="concern" cols="108" rows="5" required></textarea>
            </div>
            <br>
        </section>
