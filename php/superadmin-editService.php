...
<head>
    ...
    <link rel="stylesheet" href="../css/superadmin-editService.css">
...
<div class="header">
    <div class="title">
        <h2>Manage Services - Edit Service</h2>
    </div>
</div>
            <?php
                include('dbcon.php');
                if(isset($_POST['edit_btn']))
            {
                ...
                $query = "SELECT * FROM superadmin_services WHERE id = '$id'";
...
<div class="edit-container">
    ...
    <div class="input-box">
        ...
        <input type="text" id="service-new" name="services" value="">
    </div>
