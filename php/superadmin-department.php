...
<div class="header">
    ...
    <div class="button">
        <button id="new" onclick="window.location.href = 'superadmin-addnewdepartment.php';">+ ADD NEW</button>
    </div>
</div>
...
<div class="services-list">
    ...
    <table class="app-list" id = "table">
        ...
        <tbody>
          ...
          <tr id="department-name">
            <td id="title"><?php echo $row ['department']; ?></td>
            <td valign="bottom" align="center">

                <form action = "superadmin-editdepartment.php" method = "POST">
        ...
        <!-- TABLE FOOTER -->
          <tfoot>
            <tr>
              <td id = "page">Showing 1 to 1 of 1 results</td>
