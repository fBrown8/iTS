...
<head>
    ...
    <link rel="stylesheet" href="../css/superadmin-manageUserRoles.css">
    ...
    <title>Super Admin - Manage User Roles | I-SCoTS</title>
</head>
<body>
...
<div class="header">
    ...
    <div class="button">
        <button id="new" onclick="window.location.href = 'superadmin-userroles-add.php';">+ ADD NEW</button>
    </div>
</div>

<div class="userRoles-container">
    <div class="search">
    ...
    <table class="userRoles-list" id = "table">
        <thead>
          <tr>
            <th id="roles">ROLES</th>
            <th id="assigned-users">ASSIGNED USERS</th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr id="roles-row">
            <td id="title"><?php echo $row ['roles']; ?></td>
            <td id="numOfUsers">1 assigned user(s)</td>
          </tr>
        ...
        <!-- TABLE FOOTER -->
          <tfoot>
            <tr>
              <td>Showing 1 to 3 of 3 results</td>
